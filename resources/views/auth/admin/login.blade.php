...
@section('content')
    <!--begin::Form-->
    <form class="form" method="post" action="{{route('admin.login.confirm')}}" autocomplete="on">
        @csrf
        ...
        <div class="auth-form-bottom d-flex justify-content-between mt-2 mb-4">
            ...
            <a class="d-inline-block ml-4" href="{{route('admin.password.forget.form')}}">Forgot Your Password?</a>
        </div>
