...
@section('content')
    <!--begin::Form-->
    <form class="form" method="post" action="{{route('admin.password.reset')}}" autocomplete="on">
        @csrf
        ...
        <div class="auth-form-bottom d-flex justify-content-end mt-2 mb-4">
            <div></div>
            <a class="d-inline-block" href="{{route('admin.password.forget.form')}}">Back To Resend Link</a>
        </div>
