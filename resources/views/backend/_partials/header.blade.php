                ...
                <li class="dropdown user-dropdown">
                        ...
                        <div class="user-toggle">
                            <div class="user-avatar sm">
                                @if(Auth::guard('admin')->user()->image)
                                    <img style="height: 100%;width: 100%;object-fit: cover;" src="{{asset(Auth::guard('admin')->user()->image)}}">
                                @else
                    ...
                    <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                            ...
                            <div class="user-card">
                                <div class="user-avatar">
                                    @if(Auth::guard('admin')->user()->image)
                                        <img style="height: 100%;width: 100%;object-fit: cover;" src="{{asset(Auth::guard('admin')->user()->image)}}">
                                    @else
                                        <span>{{Auth::guard('admin')->user()->name[0]}}</span>
                                    @endif
                                </div>
                                <div class="user-info">
                        ...
                        <div class="dropdown-inner">
                            <ul class="link-list">
                                {{-- <li><a href="{{route('admin.profile-edit',Auth::guard('admin')->user()->id)}}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li> --}}
